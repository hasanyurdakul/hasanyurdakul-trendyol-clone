...
function AdvantageProducts() {
  return (
    <div className="sm:max-w-96 md:max-w-[1200px] mx-auto mt-3  rounded-xl py-8  px-4 bg-gradient-to-b from-[#EBEBEB] to-white">
      <div className="flex justify-between">
        <h1 className="text-2xl font-semibold mb-8">Avantajlı Ürünler</h1>
