...
function FlashProducts() {
  return (
    <div className="sm:max-w-96 md:max-w-[1200px] mx-auto mt-3 rounded-xl py-8  px-4 bg-flashBackground">
      <div className="flex justify-between items-start">
        ...
        <h1 className="text-2xl font-semibold flex items-center text-white">
